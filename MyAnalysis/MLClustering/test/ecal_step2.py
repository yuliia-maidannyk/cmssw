...
# Keep Calo truth products needed by MLClustering (CaloParticle/SimCluster refs)
process.FEVTDEBUGHLToutput.outputCommands.append('keep *_mix_MergedCaloTruth_*')
process.FEVTDEBUGHLToutput.outputCommands.append('keep *_mixData_MergedCaloTruth_*')
...
from SimGeneral.MixingModule.caloTruthProducer_cfi import caloParticles
process.mix.digitizers.calotruth = cms.PSet(caloParticles)
process.mix.digitizers.calotruth.doHGCAL = cms.bool(False)
process.mix.digitizers.calotruth.simHitCollections = cms.PSet(
    ecal = cms.VInputTag(
...
# Re-apply CaloTruth setup after all customisations.
# Some HLT customisers can replace mix digitizers, which would drop MergedCaloTruth.
process.mix.digitizers = cms.PSet(process.theDigitizersValid)
from SimGeneral.MixingModule.caloTruthProducer_cfi import caloParticles as _caloParticles
process.mix.digitizers.calotruth = cms.PSet(_caloParticles)
process.mix.digitizers.calotruth.doHGCAL = cms.bool(False)
process.mix.digitizers.calotruth.simHitCollections = cms.PSet(
    ecal = cms.VInputTag(
        cms.InputTag('g4SimHits', 'EcalHitsEE'),
