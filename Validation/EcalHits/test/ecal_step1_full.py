...
# with command line options: SingleGammaFlatPt8To150_cfi -n 10 -s GEN,SIM --conditions auto:phase2_realistic_T33_13TeV --beamspot DBrealisticHLLHC --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DD4hepExtendedRun4D110 --era Phase2C17I13M9 --procModifiers dd4hep --relval 9000,100 --fileout step1_0.root --no_exec --python_filename ecal_step1_full.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SingleGammaFlatPt8To150_cfi nevts:10'),
